/atom
	...
	var/light_typo = NORMAL_LIGHTING
...
/atom/proc/set_light(l_max_bright, l_inner_range, l_outer_range, l_falloff_curve = NONSENSICAL_VALUE, l_color = NONSENSICAL_VALUE, l_type = NORMAL_LIGHTING)
