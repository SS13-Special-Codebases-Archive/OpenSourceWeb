...
/datum/intercept_text/proc/build_nuke(datum/mind/correct_person)
	src.text += "<BR><BR>Cent. Com recently recieved a report of a plot to destroy one of our [vessel_type]s in your area. We believe the Nuclear Authentication Disc "
