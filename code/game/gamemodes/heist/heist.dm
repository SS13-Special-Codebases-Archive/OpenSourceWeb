...
/datum/game_mode/heist/announce()
	...
	world << "<B>An unidentified bluespace signature has slipped past the Icarus and is approaching [vessel_name()]!</B>"
	world << "Whoever they are, they're likely up to no good. Protect the crew and station resources against this dastardly threat!"
	world << "<B>Raiders:</B> Loot [vessel_name()] for anything and everything you need."
