...
/datum/game_mode/traitor
	...
	protected_jobs = list("Advisor","Captain")//AI", Currently out of the list as malf does not work for shit
	required_players = 0
	required_enemies = 1
...
/datum/game_mode/traitor/announce()
	world << "<B>Our quiet night has been interrupted by a traitor.</B>"
	world << "<B>Who can we trust?</B>"
...
/datum/game_mode/proc/greet_traitor(var/datum/mind/traitor)
	...
	traitor.current << "<B><font size=2>Your objectives have been given decades ago, after your cryo sleep, it's time for work.</font></B>"
	traitor.current << 'sound/music/traitorreveal.ogg'
	var/obj_count = 1
