...
/mob/proc/UpdateAppearance(var/list/UI=null)
	if(istype(src, /mob/living/carbon/human))
		...
		var/new_s_tone = dna.GetUIValueRange(DNA_UI_SKIN_TONE, 255)
		H.s_tone = 35 - max(min( round(new_s_tone), 255),1)         //Warning MATH.  Blame the person that wrote modules/client/preferences.dm, line 994
