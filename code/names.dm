...
var/list/first_names_dwarven_male = file2list("config/names/first_male_df.txt")
var/list/first_names_dwarven_female = file2list("config/names/first_female_df.txt")
var/list/last_names = file2list("config/names/last.txt")
var/list/last_names_dwarven = file2list("config/names/last_df.txt")
