...
/obj/item/weapon/paper/propaganda
...
/obj/item/weapon/paper/proc/thanatos()
	...
	if(istype(P, /obj/item/weapon/paper))
		if(isturf(src.loc))
			switch(alert("Do you pack the paper?", "Paper", "Yes", "No"))
				if("Yes")
					var/obj/item/weapon/package/pacote = new(src.loc)
...
/obj/item/weapon/paper/thanati/New()
