...
function addHint(imgUrl, newId, description){
    if(!newId){
        newId = ''
    }

    let message = '<div><img src="' + imgUrl + '" id="HINTHIDDEN" onmouseover="showBox(\'HINT' + newId + '\')" onmouseout="showBox(\'HINT' + newId + '\')"><div class="hint" id="HINT' + newId + '" style = "visibility: hidden;">' + description + '</div>'
    return message
}