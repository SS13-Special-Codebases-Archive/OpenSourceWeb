...
//	hud_type = /datum/hud_data/alien
	...
	flags = NO_BREATHE | NO_SCAN | NO_SLIP | NO_POISON
	...
	icobase = 'icons/mob/human_races/alien.dmi'
	deform = 'icons/mob/human_races/alien.dmi'
...
/datum/species/xenos/handle_environment_special(var/mob/living/carbon/human/H)
	...
	if(environment.gas["plasma"] > 0 || locate(/obj/structure/stool/bed/weeds) in T)
