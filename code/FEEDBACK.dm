...
/client/Topic(href, href_list, hsrc)
    ...
    switch(href_list["action"])
        ...
        if("feedback")
            ...
            //HttpPost("",list(content = bugreporttext,username = key))
            spawn(10)
                //HttpPost("",list(content = bugreport,username = key))
        ...
        if("positive")
            ...
            //HttpPost("",list(content = feedbackgoodtext,username = key))
            ...
            spawn(10)
                //HttpPost("",list(content = endfeedback,username = key))
        ...
        if ("negative")
           ...
           // HttpPost("",list(content = feedbackbadtext,username = key))
